...
/**
 * Cache implements a cache handler using files.
 *
 * For each data value being cached, Cache will store it in a separate file.
 * The cache files are placed under {@see Cache::$cachePath}.
 * Cache will perform garbage collection automatically to remove expired cache files.
 *
 * Please refer to {@see \Psr\SimpleCache\CacheInterface} for common cache operations that are supported by Cache.
 */
